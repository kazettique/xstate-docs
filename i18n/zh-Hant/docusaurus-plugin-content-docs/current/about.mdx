標題：Stately + XState 文件
短網址：&#x27;/&#x27;
隱藏標題：true

## 歡迎來到 Stately 與 XState 文件

[Stately.ai](studio.mdx) 是一款視覺化軟體建模平台，能將您的應用程式與商業邏輯建模為狀態機/狀態圖及行為者，並可擴展至任何複雜程度。
...
<div className="docs-intro">
  ...
  <p>
    <a href="/docs/xstate">XState</a>
    是頂尖的開源函式庫，專為
    協調與管理 JavaScript 及 TypeScript 應用程式的狀態而設計。
  </p>
</div>
...
<ul className="content-boxes">
  <li>
    <a className="link-box" href="/docs/states">
      ...
      <strong>立即開始</strong>
      <p>
        立即開始學習如何使用 Stately Studio 編輯器，從狀態開始探索。
      </p>
    </a>
  </li>
  <li>
    <a className="link-box" href="/docs/studio">
      <LayoutIcon size="40" />
      <strong>Stately Studio 概覽</strong>
      <p>
        深入了解 Stately Studio 的視覺化編輯器，
        並透過進階功能實現團隊協作。
      </p>
    </a>
  </li>
  ...
  <li>
    <a className="link-box" href="/docs/xstate">
      ...
      <p>
        透過我們的 JavaScript 與 TypeScript 函式庫，
        開始建立狀態機與狀態圖。
      </p>
    </a>
  </li>
...
Stately Studio 與 XState 結合使用時效能最強大。運用 Stately Studio 的視覺化編輯器協作建構應用程式邏輯，再透過 XState 將該邏輯整合至程式碼庫。

您亦可不使用 Stately Studio 直接在程式碼庫中運用 XState；若尚未熟悉 XState，亦歡迎先使用 Stately Studio。

## Stately團隊簡介

![團隊成員蓋文、法扎德、大衛、馬特烏什、珍妮、蘿拉、安德斯、尼克與凱文齊聚車庫門前，笑容滿面地互相凝視。](/stately.png)

我們是 [Stately](https://stately.ai)，這支由 XState 創始人 [David Khourshid](https://twitter.com/davidkpiano) 組建的小型團隊。Stately 正致力開發 Stately Studio，讓您能可視化應用程式邏輯並與整個團隊協作。
